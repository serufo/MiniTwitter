...
import Button from "../../Button"; // plasmic-import: FY0SzmwCIhUAv/component
...
import * as sty from "./PlasmicNewPost.module.css"; // plasmic-import: F6gmvD7KGTWRg/css
...
function PlasmicNewPost__RenderFunc(props: {
  ...
  dataFetches?: PlasmicNewPost__Fetches;
  forNode?: string;
}) {
    ...
    <React.Fragment>
      ...
      <div className={defaultcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <div className={classNames(defaultcss.all, sty.freeBox__osL1C)}>
            <div className={classNames(defaultcss.all, sty.freeBox__adL53)}>
              <div className={classNames(defaultcss.all, sty.freeBox__uHdYb)}>
                <textarea
